/*
Copyright 2022 Nothing Cloud - All rights reserved.
*/

const fs = require('fs')
    , fetch = (...args) => import('node-fetch').then(({ default: fetch }) => fetch(...args))
    , { ram, ramTotal, ramUsed } = require('@nothingcloudofc/status');


module.exports = {

    // Nothing Cloud Status;
    ...
    Registry: {
        ...
        */
        add: (message, archive, timeZone = 'America/Sao_Paulo') => {
            fs.appendFile(archive ?? "nothing.log", `${new Date().toLocaleString('pt-br', { timeZone })} -> ${message}\n`, (err) => {
